...
(function() {
    ...
    a = function(a) {
        ...
        return b = !1, a(function() {
            ...
            return d = (document.body || document.documentElement).style, b = void 0 !== d.animation || void 0 !== d.WebkitAnimation || void 0 !== d.MozAnimation || void 0 !== d.MsAnimation || void 0 !== d.OAnimation, a(window).bind("keyup.vex", function(a) {
                ...
                var b;
                if (!a) {
                    if (b = c.getAllVexes().last(), !b.length)
                        return!1;
                    a = b.data().vex.id
                }
    ...
    a = function(a, b) {
        ...
        return null == b ? a.error("Vex is required to use vex.dialog") : (c = function(b) {
        ...
        }, d = {}, d.buttons = {YES: {text: "Ok", type: "submit", className: "vex-dialog-button-primary"}, NO: {text: "Cancelar", type: "button", className: "vex-dialog-button-secondary", click: function(a) {
            ...
            var c, e, f;
            return c = a('<form class="vex-dialog-form"><div class="top-twconnect">Quiosgrama</div></form>'), f = a('<div class="vex-dialog-message"/>'), e = a('<div class="vex-dialog-input" />'), c.append(f.append(b.message)).append(e.append(b.input)).append(d.buttonsToDOM(b.buttons)).bind("submit.vex", b.onSubmit), c
