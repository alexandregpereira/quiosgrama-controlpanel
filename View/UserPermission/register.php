...
if ($login->isUserLogged()) {
    if($permissionObject->accessPermitted()) {
        ...
        $screens = $daoScreen->listAll();

        if (trim($utilities->getParameter("id")) != "") {
            $dao = new UserPermissionDaoImpl();
            $permissionUser = $dao->listOne($utilities->getParameter("id"));
            $page_title = "Edi&ccedil&atilde;o de Permiss&atilde;o de Usu&aacute;rio";
            $body_page_title = "Permiss&atilde;o de Usu&aacute;rio";
            ...
            $page_title = "Cadastro de Permiss&atilde;o de Usu&aacute;rio";
            $body_page_title = "Permiss&atilde;o de Usu&aacute;rio";
